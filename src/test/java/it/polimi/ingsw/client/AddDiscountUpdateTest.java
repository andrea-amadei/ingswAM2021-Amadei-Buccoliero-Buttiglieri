...
public class AddDiscountUpdateTest {
    ...
    public void correctApply(){
        AddDiscountUpdate update = new AddDiscountUpdate("gold", 1, "Ernestino");
        update.apply(clientModel);

        assertEquals(1, clientModel.getPlayerByName("Ernestino").getDiscountHolder()
                .getDiscounts().size());
    }

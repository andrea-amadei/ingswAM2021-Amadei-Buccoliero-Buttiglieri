...
public class UpdateAdapter implements JsonDeserializer<Update> {
    ...
    public Update deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
        ...
        switch(serializedType){
            ...
            case "add_lorenzo_faith":
                return jsonDeserializationContext.deserialize(jsonElement, AddLorenzoFaithUpdate.class);
            case "add_points":
            ...
            case "end_game_results":
                return jsonDeserializationContext.deserialize(jsonElement, EndGameUpdate.class);
            case "generic_error":

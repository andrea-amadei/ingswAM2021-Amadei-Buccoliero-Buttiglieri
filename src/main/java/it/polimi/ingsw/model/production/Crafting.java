...
public class Crafting {
    ...
    private final Map<ResourceSingle, Integer> output;
    private final int faithOutput;

    //TODO: Add crafting pot
    //private BaseStorage craftingPot;

    public Crafting(Map<ResourceType, Integer> input, Map<ResourceSingle, Integer> output, int faithOutput) {
        ...
        for(ResourceSingle i : output.keySet())
            if(output.get(i) <= 0)
    ...
    public Map<ResourceSingle, Integer> getOutput() {
